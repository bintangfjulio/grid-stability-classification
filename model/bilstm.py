...
class BiLSTM(pl.LightningModule):
    def __init__(self, lr, num_classes=2, input_size=12, hidden_size=300, num_layers=4, dropout=0.5):
    ...
    def configure_optimizers(self):
        optimizer = torch.optim.Adam(self.parameters(), lr=self.lr, betas=0.999, eps=1e-8, weight_decay=0.9)
